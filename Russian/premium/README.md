...
### Файлы базы данных
Демо-версия доступна здесь. Обращаю внимание, она содержит лишь часть примеров и не все параметры.<br/>
Для получения полной версии свяжитесь со мной - предоставлю информацию об условиях ее предоставления. Также могу дать рекомендации, какие дополнительные знания можно ивзлечь из данных в базе.
